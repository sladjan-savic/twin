...
server.registerTool(
  "context_search",
  {
    description: "Search across all knowledge stores (anchors, ADLs, orientations, policies, test plans) by free text or by id/ticket number. Returns ranked L0 results — title and abstract only, no full content. Use at session init and before targeted _load calls.",
    inputSchema: {
